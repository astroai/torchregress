...
class CTI(ConformalPredictor):
    ...
    def predict_intervals_from_density(
        ...
        try:
            ...
            logger.debug(f"Vectorized CTI interval prediction failed, falling back to loop: {e}")
...
class DistributionalConformal(ConformalPredictor):
    ...
    def predict_intervals_from_cdf(
        ...
        try:
            ...
            logger.debug(f"Vectorized icdf_fn failed: {e}")
        ...
        try:
            ...
            logger.debug(f"Auto-vectorized icdf_fn via vmap failed: {e}")
