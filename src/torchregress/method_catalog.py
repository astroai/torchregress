...
_METHODS: tuple[MethodMetadata, ...] = (
    ...
    MethodMetadata(
        name="FocalRLoss",
        family="imbalanced_loss",
        public_path="torchregress.losses.FocalRLoss",
        task_tags=("imbalance", "rare_targets", "focal"),
        maturity="Available",
        imbalance="yes",
        calibration="partial",
    ...
    MethodMetadata(
        ...
        task_tags=("heteroscedastic_noise", "aleatoric_uq", "calibration"),
        maturity="Strong",
        aleatoric="yes",
        calibration="partial",
        notes=(
            "Analytic Continuous Ranked Probability Score for diagonal Gaussian predictions. "
            "Proper scoring rule with target-native units; less tail-sensitive than NLL."
        ),
    ),
    MethodMetadata(
    ...
    MethodMetadata(
        ...
        family="quantile",
        public_path="torchregress.losses.MultiQuantileLoss",
        task_tags=("prediction_intervals", "non_gaussian", "multi_quantile"),
        maturity="Strong",
        non_gaussian="yes",
        calibration="yes",
        notes="Multi-quantile loss; multiple quantile predictions per target dimension.",
    ),
    MethodMetadata(
        name="ExpectileLoss",
        family="expectile",
        public_path="torchregress.losses.ExpectileLoss",
        task_tags=("prediction_intervals", "non_gaussian", "expectile"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Asymmetric least-squares expectile estimation; L2 analog of quantile regression.",
    ),
    MethodMetadata(
        name="MultiExpectileLoss",
        family="expectile",
        public_path="torchregress.losses.MultiExpectileLoss",
        task_tags=("prediction_intervals", "non_gaussian", "multi_expectile"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Simultaneous multi-expectile loss for distribution-free interval estimation.",
    ),
    MethodMetadata(
        name="AsymmetricLeastSquaresLoss",
        family="expectile",
        public_path="torchregress.losses.AsymmetricLeastSquaresLoss",
        task_tags=("prediction_intervals", "non_gaussian", "expectile"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Base asymmetric least-squares loss for expectile regression.",
    ),
    MethodMetadata(
        name="ConformalLoss",
        family="conformal",
    ...
    MethodMetadata(
        name="SplitConformal",
        family="conformal",
        public_path="torchregress.losses.SplitConformal",
        task_tags=("coverage_guarantees", "calibration", "baseline"),
        maturity="Core",
        non_gaussian="yes",
        calibration="yes",
        notes="Standard split conformal prediction with finite-sample coverage guarantees.",
    ),
    MethodMetadata(
        name="CQR",
        family="conformal",
        public_path="torchregress.losses.CQR",
        task_tags=("coverage_guarantees", "calibration", "heteroscedastic_noise"),
        maturity="Strong",
        non_gaussian="yes",
        calibration="yes",
        notes="Conformalized Quantile Regression: adapts interval width to heteroscedasticity.",
    ),
    MethodMetadata(
        name="CTI",
        family="conformal",
        public_path="torchregress.losses.CTI",
        task_tags=("coverage_guarantees", "calibration", "distributional"),
        maturity="Available",
        non_gaussian="yes",
        calibration="yes",
    ...
    MethodMetadata(
        name="TransformedTargetLoss",
        family="target_transform",
        public_path="torchregress.losses.TransformedTargetLoss",
        task_tags=("target_transform", "skewed_targets"),
        maturity="Available",
        non_gaussian="partial",
        calibration="partial",
        notes="Base class for target-transformed losses; any forward/inverse transform pair.",
    ),
    MethodMetadata(
    ...
    MethodMetadata(
        name="PoissonDevianceLoss",
        family="poisson",
        public_path="torchregress.losses.PoissonDevianceLoss",
        task_tags=("count_data", "non_gaussian", "poisson"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Poisson deviance (negative log-likelihood) for count targets with variance = mean.",
    ),
    MethodMetadata(
        name="PoissonLikelihoodRatioLoss",
        family="poisson",
        public_path="torchregress.losses.PoissonLikelihoodRatioLoss",
        task_tags=("count_data", "non_gaussian", "poisson", "ablation"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Poisson likelihood-ratio loss for model comparison and ablation studies.",
    ),
    MethodMetadata(
        name="NegativeBinomialNLLLoss",
        family="poisson",
        public_path="torchregress.losses.NegativeBinomialNLLLoss",
        task_tags=("count_data", "non_gaussian", "overdispersion"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Negative Binomial NLL for overdispersed count data with variance = mu + mu^2/r.",
    ),
    MethodMetadata(
        name="ZeroInflatedPoissonNLLLoss",
        family="poisson",
        public_path="torchregress.losses.ZeroInflatedPoissonNLLLoss",
        task_tags=("count_data", "non_gaussian", "zero_inflated"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Zero-inflated Poisson NLL for count data with excess zeros.",
    ),
    MethodMetadata(
        name="TweedieLoss",
        family="tweedie",
        public_path="torchregress.losses.TweedieLoss",
        task_tags=("tweedie", "non_gaussian", "positive_targets", "compound_poisson"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Tweedie loss; variance ∝ mean^p (1<p<2 for compound Poisson-gamma).",
    ),
    MethodMetadata(
        name="GammaLoss",
        family="tweedie",
        public_path="torchregress.losses.GammaLoss",
        task_tags=("tweedie", "non_gaussian", "positive_targets", "right_skewed"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Gamma NLL for positive, right-skewed continuous targets (Tweedie p=2).",
    ),
    MethodMetadata(
        name="InverseGaussianLoss",
        family="tweedie",
        public_path="torchregress.losses.InverseGaussianLoss",
        task_tags=("tweedie", "non_gaussian", "positive_targets"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Inverse Gaussian NLL for positive targets; variance ∝ mean^3 (Tweedie p=3).",
    ),
    MethodMetadata(
        name="CompoundPoissonLoss",
        family="tweedie",
        public_path="torchregress.losses.CompoundPoissonLoss",
        task_tags=("tweedie", "non_gaussian", "zero_inflated", "positive_targets"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Compound Poisson-gamma loss for mixed zero-inflated continuous positive targets.",
    ),
    MethodMetadata(
        name="EvidentialRegressionLoss",
        family="evidential",
        public_path="torchregress.losses.EvidentialRegressionLoss",
        task_tags=("uq_decomposition", "single_pass", "evidential"),
        maturity="Available",
        epistemic="yes",
        aleatoric="yes",
        decomposition="yes",
        calibration="partial",
        notes="NIG evidential regression; single-pass aleatoric and epistemic uncertainty.",
    ),
    MethodMetadata(
        name="PoissonGaussianMixtureLoss",
        family="poisson_gaussian",
        public_path="torchregress.losses.PoissonGaussianMixtureLoss",
        task_tags=("count_data", "non_gaussian", "mixture", "noisy_counts"),
        maturity="Available",
        non_gaussian="yes",
        multimodal="yes",
        calibration="partial",
        notes="Poisson-Gaussian mixture for count data with Gaussian readout noise.",
    ),
    MethodMetadata(
        name="EnhancedPoissonGaussianMixtureLoss",
        family="poisson_gaussian",
        public_path="torchregress.losses.EnhancedPoissonGaussianMixtureLoss",
        task_tags=("count_data", "non_gaussian", "mixture", "noisy_counts"),
        maturity="Available",
        non_gaussian="yes",
        multimodal="yes",
        calibration="partial",
        notes="Enhanced Poisson-Gaussian mixture with improved stability and learnable parameters.",
    ),
    MethodMetadata(
        name="PoissonGaussianLikelihoodRatioLoss",
        family="poisson_gaussian",
        public_path="torchregress.losses.PoissonGaussianLikelihoodRatioLoss",
        task_tags=("count_data", "non_gaussian", "mixture", "ablation"),
        maturity="Available",
        non_gaussian="yes",
        calibration="partial",
        notes="Poisson-Gaussian likelihood-ratio loss for model comparison and hypothesis testing.",
    ),
    MethodMetadata(
        name="BoundedHead",
        family="constraints",
    ...
    MethodMetadata(
        name="LatentNN",
        family="eiv",
        public_path="torchregress.algorithms.LatentNN",
        task_tags=("noisy_features", "measurement_error", "latent_input"),
        maturity="Available",
        noisy_features_eiv="yes",
        calibration="partial",
        notes=(
            "Jointly optimises network parameters and per-sample latent clean inputs "
            "under a Gaussian quadratic penalty. Requires known input noise sigma_x."
        ),
    ),
    MethodMetadata(
    ...
    MethodMetadata(
        ...
        task_tags=("noisy_features", "measurement_error", "feature_encoding"),
        maturity="Available",
        noisy_features_eiv="yes",
        calibration="partial",
        notes=(
            "Encodes raw features alongside derived quality signals (log-uncertainty, SNR, "
            "quality-gated features). Lightweight alternative to latent-input optimization."
        ),
    ),
    MethodMetadata(
        name="NoiseAwareRegressor",
        family="eiv",
        public_path="torchregress.algorithms.NoiseAwareRegressor",
        task_tags=("noisy_features", "measurement_error", "feature_encoding"),
        maturity="Available",
        noisy_features_eiv="yes",
        calibration="partial",
        notes=(
            "Convenience wrapper pairing an ErrorAwareFeatureEncoder with a "
            "configurable prediction backbone for noisy-input regression."
        ),
    ),
    MethodMetadata(
