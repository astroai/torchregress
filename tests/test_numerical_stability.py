...
from torchregression.losses import (
    MSELoss, MAELoss, GaussianNLLLoss, HuberLoss, PseudoHuberLoss,
    LogCoshLoss, CauchyLoss, QuantileLoss, ExpectileLoss, PoissonLoss,
    TweedieLoss
...
@pytest.mark.parametrize("loss_class", [
    MSELoss, MAELoss, HuberLoss, PseudoHuberLoss,
