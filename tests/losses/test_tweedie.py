...
from torchregression.losses.tweedie import TweedieLoss, GammaLoss, InverseGaussianLoss, CompoundPoissonLoss
...
class TestTweedieLoss(unittest.TestCase):
    ...
    def test_gradient_flow(self):
        ...
        y_pred = torch.rand(self.batch_size, self.n_features, 
