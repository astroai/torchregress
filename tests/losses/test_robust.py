import pytest
import torch
from torchregression.losses.robust import (
    L1Loss, HuberLoss, PseudoHuberLoss,
    LogCoshLoss, CharbonnierLoss, LqLoss,
    TukeyBiweightLoss, WinsorizedLoss, LogBarrierLoss,
    AdaptiveHuberLoss, ClippedLoss, FairLoss, CauchyLoss
)
...
class TestRobustLossesNumericalStability:
    ...
    def test_pseudo_huber_gradient_flow(self):
        ...
        from torchregression.losses.robust import PseudoHuberLoss
    ...
    def test_cauchy_gradient_flow(self):
        ...
        from torchregression.losses.robust import CauchyLoss
    ...
    def test_extreme_values(self):
        ...
        from torchregression.losses.robust import HuberLoss, PseudoHuberLoss, LogCoshLoss, CauchyLoss
