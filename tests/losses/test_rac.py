...
import torch
import numpy as np
from torchregress.losses.rac import (
...
class TestRegressionAsClassificationLoss:
    ...
    def test_factory_function(self):
        ...
        from torchregress.losses.rac import regression_as_classification
    ...
    def test_uncertainty_regression_factory(self):
        ...
        from torchregress.losses.rac import uncertainty_regression
...
class TestRAGLossNumericalStability:
    def test_rag_gradient_flow(self):
        ...
        from torchregress.losses.rac import RAGLoss
