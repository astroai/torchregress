...
| # | Reference |
|:-:|:----------|
| 1 | P.J. Huber. "Robust Estimation of a Location Parameter." *Ann. Math. Stat.*, **1964**. |
| 2 | D. Arpit et al. "A Closer Look at Memorization in Deep Networks." *ICML*, **2017**. |
| 3 | B. Han et al. "Co-teaching: Robust Training of Deep Neural Networks with Extremely Noisy Labels." *NeurIPS*, **2018**. |
